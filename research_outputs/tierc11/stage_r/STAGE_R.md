...
# TIER-C11 · STAGE R-a — ranges done once (R1 · R2 · R3 · R5)

Contract: exchange/queue/2026-09-24_TC11_APOLLO.md (bb38e016…) · readings LEANS L-R.1..L-R.5, L-R.7 + AM-1, AM-4, AM-6 · executor HEPHAESTUS · seed 20260924 · substrate tc11_20260925

No registered book is built in Stage R-a. The books read (both TIER-E here):

- v6: n 200 · ΣR +40.807566 (the sum of the books table's 6-dp rows; full precision +40.807565 per books/build_manifest.json) · mean R +0.204038 (book, not a verdict; books/v6_campaigns.parquet) [SR-14]
- trg912: n 199 · ΣR +92.318442 (the sum of the books table's 6-dp rows; full precision +92.318440 per books/build_manifest.json) · mean R +0.463912 (book, not a verdict; books/trg912_campaigns.parquet) [SR-14]

## Executor readings of this stage

- SR-1 R1 COUNTS: a confirmed range's era is its CONFIRM bar's CLOSE [L-1.3] (the census's height_rows law); density per 100 bars = 100 x confirmed ranges in the era / bars of the lens in the era (tuning = bars with close <= 2024-06-30T23:59:59Z); ALL equals C.density_per_100 on the whole tape (asserted). The pick of record is READ from SCALE_PICKS.json (a pin) — never re-fitted; frozen 3.0 beside.
- SR-2 R2 TOLLS [L-R.4, L-1.1, L-1.2]: taker = fee_schedule round_trip_bps_used (10.0; == C.toll_bps_for, asserted); charter twin = 2 x (taker 5.0 + the stem's charter slippage tier A 2 / B 5 / C 10) bps round trip; maker twin = 2 x maker 2.0 = 4.0 bps round trip (maker legs carry zero slippage). A pooled height row pools per-range ratios, each struck on its own asset's toll; a pooled edge row's toll is the BINDING (max) per-asset median (census law C-f) — both the census's own functions, unchanged.
- SR-3 THE WORD [L-R.4]: PASS iff the height leg (n_ranges >= 30, median(ratio) >= 3.0, share(ratio < 1) <= 0.10) AND the edge leg (edge_n >= 30, edge_n_ranges >= 30, net = round(median term H20, 8) - round(toll, 8) > 0) both pass within the row's era; a FAIL with any leg under its floor (n_ranges, edge_n_ranges or edge_n < 30) reads 'FAIL (provisional, n<30)'; else 'FAIL'. The census's own gate booleans are cross-checked (HALT on disagreement).
- SR-4 THE LENS VERDICT OF RECORD [L-R.4] = the POOLED:CLASSIC5 row, HOLDOUT era, calibrated scale (each member at its FILED pick), taker toll; 'FAIL — maker twin PASSES (…)' when taker FAILs and the maker twin of the same row PASSES. Every other row is Tier-E, its word in `would_read`, collared.
- SR-5 POOLED SCALE: a pooled calibrated row pools each member's run at ITS OWN filed pick (the census's pooling of per-asset runs); pick_window / scale_in_sample / stability_changed are carried per row, pooled rows name their fallback and stability-changed members [AM-4].
...
- SR-9 nest-book [L-R.5]: kinds v6transform (4h bars from the arm), lane4h (4h from the entry), relay (4h bars from the v6 arm — its stop, R, window and ride are 4h; its 1h entry instant is the named event 'entry'), scalp5m (5m bars from the entry). Columns read beyond the REGBOOK INTERFACE: arm = arm_close_ms | window_arm_close_ms | arm_ms + one lens bar (the arm bar's OPEN) | (v6transform) v6's own arm joined on the pairing key (symbol, entry_ms) [L-1.5]; kinds v6transform / relay start their bar closes there (a close event); exit = exit_stamp_ms (ride11's stamp of record) | exit_event_ms (the books' L-R.5 stamp) | derived: an intrabar reason (stop / tp / target) -> the OPEN of the lens bar holding exit_close_ms, a close reason (bell* / corridor_end / warn* / invalidation* / close*) -> exit_close_ms; any other reason HALTs; an exit stamp before exit_close_ms carries the close-stamped twin 'exit_post_event'; a corridor_end campaign (OPEN at the pin) is stamped 'as_of_pin', never 'exit'; +1R = latch_stamp_ms (+ latch_post_event_ms) | latch_1h_ms gated by latched_1h: the resolving 1h child's close, a PARENT-decided latch (latch_1h_by 'parent' | its parent bar listed in walk_mismatch_ms) -> the parent's OPEN with its close as the twin, an undecidable latch at a parent close HALTs | derived on the lens tape by the bar-OPEN law when reached_1r is True (v6transform / lane4h) | none; harvest = harvest_close_ms | harvest_ms + one lens bar | harvest_i on the lens tape (checked) | (v6transform) v6's own harvest close joined on the pairing key, checked per row against `harvested` and the exit stamp — gated by `harvested`; a close event inside (entry close, exit]; adds / others = add1_close_ms, add2_close_ms (close events; gated by n_adds); ev_<name>_ms (kind <name>, as given); UNSTAMPED = a campaign whose own record says an event happened (latched_1h / reached_1r True, harvested True, n_adds > k) but no source above stamps it is counted, and the door REFUSES to file (HALT naming the counts) [L-R.5 'plus the named events'].
- SR-10 TC10 CONTINUITY [AM-1]: TC10's census/height_toll_verdict.parquet rows (taker, 10 bps) beside TC11's taker rows at 5m/4h/1d, keyed (lens, scale_kind, asset, era); POOLED:PANEL17 <-> TC10 'POOLED:ALL'. TC10's calibrated scale is ITS whole-tape pick (TC10 L2), not TC11's tuning pick; its frozen3.0 rows are the like-for-like ones.
- SR-11 R5 ANCHOR [L-R.7]: TC10's five-row table (control_entry_by_state.parquet, 4h, frozen 3.0) is re-derived from the FILED TC10 control journal's 200 campaigns with the TC11 nest (4h state at the entry close; IN_RANGE printed as TC10's 'NEUTRAL'; |dist_signed_atr| = TC10's unsigned dist) and must equal it exactly (the build HALTs otherwise); the TC11 v6 book's own five rows ride beside (all eleven columns, both sides).
- SR-12 HONESTY OF THE AGGREGATED TABLES [L-R.2 SCALE-IN-SAMPLE, AM-4]: every R5_CHOP / NEST_GRID row carries lenses_read, pick_window, stability_changed_members, n_scale_in_sample, n_stability_changed and the HOLDOUT slice (n_holdout, mean_net_r_holdout, p_win_holdout, sum_net_r_holdout; era = the entry's CLOSE [L-1.3]) — the causal slice of a tuning-calibrated read, printed beside every cell.
- SR-13 NO VERDICT WORD OFF THE RECORD [L-1.4, L-R.4]: R2's `word` and `verdict` are printed on the seven lens-verdict-of-record rows only; every Tier-E row carries its word as `would_read`, and the census's booleans are renamed height_leg_would_pass / edge_leg_would_pass / census_would_pass (TC10's: tc10_would_read / tc10_would_pass).
- SR-14 THE PROBE [the nest-book self-test]: nestbook_probe/V6-PROBE is books/v6_campaigns.parquet (floats at the books table's 6 dp) in the REGBOOK schema — NOT the full-precision v6 base arm the stages file (its book_sha256 differs), never scored; the books' full-precision ΣR is read from books/build_manifest.json and printed beside.

## §0 lines this stage feeds

- R5 chop table (printed first in §0): see R5 below.
- The lens verdicts of record per lens: 5m **FAIL** · 15m **FAIL** · 1h **FAIL** · 4h **FAIL** · 12h **FAIL** · 1d **FAIL** · 1w **FAIL (provisional, n<30)**
- Stage S precondition [L-S.1]: the 1h lens verdict of record is FAIL -> CLOSED BY R2 (1h: FAIL); the tuning-era word beside it (Tier-E) is FAIL.
...
## Findings not fixed (for the operator) [L-R.4]
...
- R3 lanes: the contract's R3 covers every card including the lanes; this build stamps base v6 and 9/12 only. The lanes are stamped by the nest-book door in the lanes pass. The door REFUSES (HALT, naming the counts) a regbook whose own record says a harvest / add / +1R happened with no instant to stamp it [L-R.5 'plus the named events'] — such regbooks must file the instant columns listed in SR-9 first.
...
## R1 · LENSES [L-R.1, L-R.2, L-R.3] — Tier-E

Collar on every table below unless marked RECORD: tier = 'TIER-E' · selection_not_a_result = 'a SELECTION, not a result' · gates = 'nothing'.

L-R.3 PINS = TC10 sha — verified at import, HALT on any mismatch:
  analytics/rangefinder_census.py sha256 19c5507ff2d39b68aa119ff701aef58a2d219fa287c34cdf7302ebf2bbb7b37d == STEP0_RECORD sha256_expected == literal: True
  engine/rangefinder.py sha256 bbae464fdc8e0e01fc90b286aa79e726fcff4422e6118dee1173f2460dab84d4 == STEP0_RECORD sha256_expected == literal: True
  the 12 pins, key order of record (research_outputs/tierc10/STEP0_RECORD.json pins_of_record; PINS-OK 12/12 — port == machine == Pine, key order included):
    LEG_MIN           0.5
    REV_MIN           1.75
    TOUCH_EPS         0.6
    DEV_RETURN_BARS   7
    ...
    MEM_TTL_BARS      400
    ATR_LEN           14
  recipe preconditions (not in the 12; asof_view asserts them): REDRAW_BASIS 'wick' · MULTI_ACTIVE 0 · MEM_CAP_PER_SIDE 6
  C.RETEST_PINS: margin_atr 1.0 · hold_bars 3 · ttl_bars 400 · grid_sha 2135ca663a7c407ca1a2a99165692bd3a9a9cd90de458e03dabdc2e32855e7b3 · status 'TUNED-PINS (R1 protocol, tuning era only)' (the ONE 5m-tuned pair, applied to every lens)
...
### Confirmed ranges and density per 100 bars, by era (era = the confirm bar's CLOSE) — at the pick of record, and at frozen 3.0

| asset | lens | n_confirmed_ALL | n_confirmed_tuning | n_confirmed_holdout | density_per_100_ALL | density_per_100_tuning | density_per_100_holdout | n_confirmed_frozen_ALL | n_confirmed_frozen_tuning | n_confirmed_frozen_holdout | density_frozen_per_100_ALL | density_frozen_per_100_holdout | density_window_matches_filed |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| BTCUSDT | 5m | 6468 | 4067 | 2401 | 0.8728 | 0.8036 | 1.0217 | 2835 | 1839 | 996 | 0.3825 | 0.4238 | True |
| BTCUSDT | 15m | 2030 | 1340 | 690 | 0.8218 | 0.7943 | 0.8808 | 918 | 611 | 307 | 0.3716 | 0.3919 | True |
| BTCUSDT | 1h | 522 | 347 | 175 | 0.8452 | 0.8228 | 0.8935 | 223 | 152 | 71 | 0.3611 | 0.3625 | True |
| BTCUSDT | 4h | 111 | 77 | 34 | 0.7189 | 0.7303 | 0.6943 | 63 | 40 | 23 | 0.4080 | 0.4697 | True |
| BTCUSDT | 12h | 34 | 23 | 11 | 0.6606 | 0.6545 | 0.6736 | 18 | 10 | 8 | 0.3497 | 0.4899 | True |
| BTCUSDT | 1d | 20 | 12 | 8 | 0.7773 | 0.6834 | 0.9792 | 11 | 8 | 3 | 0.4275 | 0.3672 | True |
| BTCUSDT | 1w | 3 | 3 | 0 | 0.8174 | 1.2000 | 0.0000 | 2 | 2 | 0 | 0.5450 | 0.0000 | True |
| tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| BTCUSDT | 15m | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| BTCUSDT | 1h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| BTCUSDT | 4h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| BTCUSDT | 12h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| BTCUSDT | 1d | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| BTCUSDT | 1w | whole-tape (fallback) | IN-SAMPLE (fallback: the tuning era holds 250 < 400 bars of this lens; fit on the whole tape) |
| ETHUSDT | 5m | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| ETHUSDT | 15m | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| ETHUSDT | 1h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| ETHUSDT | 4h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| ETHUSDT | 12h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| ETHUSDT | 1d | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| ETHUSDT | 1w | whole-tape (fallback) | IN-SAMPLE (fallback: the tuning era holds 238 < 400 bars of this lens; fit on the whole tape) |
| SOLUSDT | 5m | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| SOLUSDT | 15m | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| SOLUSDT | 1h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| SOLUSDT | 4h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| SOLUSDT | 12h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| SOLUSDT | 1d | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| SOLUSDT | 1w | whole-tape (fallback) | IN-SAMPLE (fallback: the tuning era holds 196 < 400 bars of this lens; fit on the whole tape) |
| NEARUSDT | 5m | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| NEARUSDT | 15m | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| NEARUSDT | 1h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| NEARUSDT | 4h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| NEARUSDT | 12h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| NEARUSDT | 1d | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| NEARUSDT | 1w | whole-tape (fallback) | IN-SAMPLE (fallback: the tuning era holds 192 < 400 bars of this lens; fit on the whole tape) |
| ZECUSDT | 5m | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| ZECUSDT | 15m | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| ZECUSDT | 1h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| ZECUSDT | 4h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| ZECUSDT | 12h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| ZECUSDT | 1d | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| ZECUSDT | 1w | whole-tape (fallback) | IN-SAMPLE (fallback: the tuning era holds 228 < 400 bars of this lens; fit on the whole tape) |
| ENAUSDT | 1h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| ENAUSDT | 4h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| ENAUSDT | 1d | whole-tape (fallback) | IN-SAMPLE (fallback: the tuning era holds 88 < 400 bars of this lens; fit on the whole tape) |
| PUMPUSDT | 1h | whole-tape (fallback) | IN-SAMPLE (fallback: the tuning era holds 0 < 400 bars of this lens; fit on the whole tape) |
| PUMPUSDT | 4h | whole-tape (fallback) | IN-SAMPLE (fallback: the tuning era holds 0 < 400 bars of this lens; fit on the whole tape) |
| PUMPUSDT | 1d | whole-tape (fallback) | IN-SAMPLE (fallback: the tuning era holds 0 < 400 bars of this lens; fit on the whole tape) |
| HYPEUSDT | 1h | whole-tape (fallback) | IN-SAMPLE (fallback: the tuning era holds 0 < 400 bars of this lens; fit on the whole tape) |
| HYPEUSDT | 4h | whole-tape (fallback) | IN-SAMPLE (fallback: the tuning era holds 0 < 400 bars of this lens; fit on the whole tape) |
| HYPEUSDT | 1d | whole-tape (fallback) | IN-SAMPLE (fallback: the tuning era holds 0 < 400 bars of this lens; fit on the whole tape) |
| MNTUSDT_BYBIT | 1h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| MNTUSDT_BYBIT | 4h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| MNTUSDT_BYBIT | 1d | whole-tape (fallback) | IN-SAMPLE (fallback: the tuning era holds 271 < 400 bars of this lens; fit on the whole tape) |
| SUIUSDT | 1h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| SUIUSDT | 4h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| SUIUSDT | 1d | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| LTCUSDT | 1h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| LTCUSDT | 4h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| LTCUSDT | 1d | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| XMRUSDT | 1h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| XMRUSDT | 4h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| XMRUSDT | 1d | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| BNBUSDT | 1h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| BNBUSDT | 4h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| BNBUSDT | 1d | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| UNIUSDT | 1h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| UNIUSDT | 4h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| UNIUSDT | 1d | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| 1000PEPEUSDT | 1h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| 1000PEPEUSDT | 4h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| 1000PEPEUSDT | 1d | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| DOGEUSDT | 1h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| DOGEUSDT | 4h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| DOGEUSDT | 1d | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| 1000BONKUSDT | 1h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| 1000BONKUSDT | 4h | tuning | OUT-OF-SAMPLE for holdout (tuning-era pick; IN-SAMPLE for tuning) |
| 1000BONKUSDT | 1d | whole-tape (fallback) | IN-SAMPLE (fallback: the tuning era holds 220 < 400 bars of this lens; fit on the whole tape) |

### Stability [L-R.2]: CLASSIC5 x {1h, 4h, 12h}, first half of tuning vs the whole tuning era
...
### The whole density grid (SCALE_GRID.parquet, 2035 rows, content sha d2b5ec141516d7bea1fe4ab296c97087233d7daa40044eebeeda730604ea2c2b; * = the window's pick)
...
- probe regbook nestbook_probe/V6-PROBE/base.parquet (book_sha256 13feaf39a2fc25e62d29f9fbc035f7d6a15c8cab2b5e928392fd1a8249e39b72), nest_books/V6-PROBE__base.parquet: 19386 rows, content sha a84ce938c40e9a9fce3f7267df1b7b90c2f96ebb3233775306d5355bd291085e; rows by kind {"arm": 400, "bar_close": 17264, "bell": 8, "entry": 400, "exit": 400, "exit_post_event": 392, "harvest": 110, "plus_1r": 206, "plus_1r_post_event": 206}
