...
BOX_CAPACITY = 6_390_000          # the box AT FILING (2026-08-06); see
                                  # docs/history/DIGEST_RETIRED_2026-08-15.md
                                  # §2 "Budget" -- the DIGEST was RETIRED by
                                  # ruling 007 and its final edition moved
                                  # there; the VALUE stays pinned, only the
                                  # pointer follows the file.
                                  # Raised to 16_000_000 on 2026-08-15 --
