...
| **Zone bands** | Amber **Z1** (gov 9) and purple **Z2** (gov 89) arm with **every** campaign; cyan **Z3** (gov 89–200 band) appears/arms only when stage-aligned. Bands visible ≠ armed — arming needs a live campaign (dir ≠ 0). |
...
| Z2 band | purple | Gov-89 zone (±0.35). **The campaign entry zone — armed in every campaign, provisional included** (v11.0.2). |
